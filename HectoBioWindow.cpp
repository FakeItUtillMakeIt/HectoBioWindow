    ...
    : QMainWindow(parent)
{
	...
	ui.signalPlot->setAxisTitle(QwtPlot::xBottom, "sample point");
	...
	******************************************************/
	...
	else if (ADRun && display_flag)
	{
		...
		if (!DISPLAY_MOTHOD0)
		{
			...
			ui.signalPlot->setAxisScale(QwtPlot::yLeft, -100, 200, 0);
